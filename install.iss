...
#define ApplicationName 'BlinderKitten'
#define ApplicationVersion GetStringFileInfo('Binaries/CI/App/BlinderKitten.exe',"ProductVersion")

[Setup]
AppName={#ApplicationName}
AppId={#ApplicationName}
AppVersion={#ApplicationVersion}
AppPublisher=Norbert Rostaing
AppPublisherURL=http://blinderkitten.lighting
...
ArchitecturesAllowed=x64 and arm64 and x64compatible
ArchitecturesInstallIn64BitMode=x64 and arm64 and x64compatible
OutputDir=/
