...
void MainContentComponent::getCommandInfo(CommandID commandID, ApplicationCommandInfo& result) 
{
	...
	case BlinderKittenCommandId::keyClear:
		...
		result.addDefaultKeypress(KeyPress::createFromDescription("x").getKeyCode(), ModifierKeys::noModifiers);
		break;

	case BlinderKittenCommandId::keyClearAll:
		result.setInfo("Clear All", "", "Direct Commands", 0);
		result.addDefaultKeypress(KeyPress::createFromDescription("x").getKeyCode(), ModifierKeys::altModifier);
		break;
