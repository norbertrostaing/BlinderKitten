...
MIDIManager::MIDIManager()
{
	...
	// midiRouterDefaultType = dynamic_cast<BKEngine *>(Engine::mainEngine)->defaultBehaviors.addEnumParameter("MIDI Router Ouput Type","Choose the default type when choosing a MIDI Module as Router output");
