...
public:
    ...
    void setRotaryValue(int page, int col, int row, float value, String origin, int incrementIndex, bool isRelative);
    void setFaderValue(int page, int col, float value, String origin, int incrementIndex, bool isRelative);
