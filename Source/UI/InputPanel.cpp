    ...
    ControllableContainer("Input Panel")
{
    ...
    paramDot = addTrigger(".", "."); btnDot = paramDot->createButtonUI(); addAndMakeVisible(btnDot);  
    ...
    paramBackspace = addTrigger("Backspace", "Backspace"); btnBackspace = paramBackspace->createButtonUI(); addAndMakeVisible(btnBackspace);  
