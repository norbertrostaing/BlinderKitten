...
public:
    ...
    enum ActionType { CL_GO, CL_GOBACK, CL_GOINSTANT, CL_GOBACKINSTANT, CL_OFF, CL_HTPLEVEL, CL_LTPLEVEL, CL_FLASH, CL_SWOP, CL_LOAD, CL_LOADANDGO, CL_FLASHLEVEL, CL_GORANDOM, CL_TOGGLE, CL_GOALLLOADED, CL_CHASERSPEED, CL_CHASERTAPTEMPO};
