...
public:
    ...
    enum ActionType { CAR_START, CAR_STOP, CAR_SIZE, CAR_FLASH, CAR_SWOP, CAR_SPEED, CAR_DOUBLESPEED, CAR_HALFSPEED, CAR_TAPTEMPO, CAR_TOGGLE, CAR_BBW, CAR_STOP_INSTANT };
